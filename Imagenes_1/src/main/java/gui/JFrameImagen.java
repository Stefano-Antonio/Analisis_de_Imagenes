...
public class JFrameImagen extends javax.swing.JFrame {
    ...
    public JFrameImagen(Image imagen) {
        ...
        //obtener un tono eandom en la imagen
        int w = imagen.getWidth(null);
        int h = imagen.getHeight(null);
        Image escalada = Herramientas.HerramientasImagen.toBufferedImage(imagen).getScaledInstance(w, h, BufferedImage.TYPE_INT_RGB);
        this.jLabelImagen.setIcon(new ImageIcon(escalada));
        BufferedImage bufferedImage = Herramientas.HerramientasImagen.toBufferedImage(escalada);
        //-------------------
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jLabelImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // abrir la imagen para poder mandarla
